...
contract TestCompoundConnector is testStarter, MainnetAddresses {
    ...
    function setUp() public {
        ...
        // --------------------------------- init connector ---------------------------------
        connector =
            new CompoundConnector(address(chainlinkOracle), BaseConnectorCP(registry, 0, swapHandler, noyaOracle));
    ...
    function testSupplyAndBorrowFlowCompound() public {
        ...
        connector.withdrawOrBorrow(cUSDC, USDC, 2200e6);
