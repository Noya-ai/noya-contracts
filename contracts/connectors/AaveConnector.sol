...
contract AaveConnector is BaseConnector {
    ...
    function claimRewards(address rewardController, address[] memory aTokens) external onlyManager {
     ...
     */
    function adjustIsolationModeAssetAsCollateral(address asset, bool useAsCollateral) public {
